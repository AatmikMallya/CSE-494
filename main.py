...
def main():
    ...
    parser.add_argument('--cuda', type=str2bool, default=True,
                        help = 'enable cuda')
    parser.add_argument('--seed', type=int, default=494598,
                        help='random seed')
    ...
    parser.add_argument('--max_len_tcr', type=int, default=25,
                        help='maximum TCR length allowed')
    parser.add_argument('--max_len_pep', type=int, default=25,
                        help='maximum peptide length allowed')
    parser.add_argument('--n_fold', type=int, default=5,
                        help='number of cross-validation folds')
    parser.add_argument('--idx_test_fold', type=int, default=4,
    ...
    parser.add_argument('--split_type', type=str, default='tcr',
                        help='how to split the dataset')

    # Add more arguments here
    parser.add_argument('--lin_size', type=int, default=128,
                        help='A sample student argument')
